			...
			<div class="div_buscador">
				<div class="container position-relative" style="padding-top: 40px;">
					<div class="div_botones d-flex" style="top: 0;">
						...
						<a class="btn_volver <?= $plataforma ?>" href="index-contador.php" style="top: 10px;"><svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-arrow-left">
